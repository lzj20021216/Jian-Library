                        ...
                        switch (_languageReceiver)
                        {
                            ...
                            default:
                                while (true)
                                {
                                    ...
                                    if (_breaker == false)
                                    {
                                        Console.WriteLine("Inputted error, please try again!(输入有误，请重试！)");
                                        _languageReceiver = Console.ReadLine();
...
", _languageChooser[23]);
        ...
        public void Features(string disp, string[] args)
        {
            switch (disp)
            {
                case "1":
...
----------------------------------------------------------------------------
----------------------------------------------------------------------------
", _languageChooser[25], _languageChooser[26]);
                    _recTimer++;
...
----------------------------------------------------------------------------
----------------------------------------------------------------------------
", _languageChooser[27], _languageChooser[28]);
                    _recTimer++;
                    _languageController = false;
                    Console.ReadKey();
                    Console.Clear();
        ...
        /// </summary>
        /// <param name="args">Main Method</param>
        public void Calculator_DisplayBoard(string[] args)
        {
            while (_rec)
            {
                _sNum = "5";
        ...
        public void Viewer(int[] inps, int number, string[] args)
        {
        ...
        public void RecycleChecker(string permission, string[] args)
        {
            for (int i = 0; i < 2; i++)
            {
                if (i == 1 || i == 3)
        ...
        public void ColorController(string colorReceiver, string cl, string[] args)
        {
        ...
        /// <param name="args">Main Method</param>
        /// <returns></returns>
        public bool Breaker(string input, string[] args)
        {
